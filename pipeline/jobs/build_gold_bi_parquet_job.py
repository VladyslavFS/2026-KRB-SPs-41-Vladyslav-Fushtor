...
class BuildGoldBIPartitionsJob:
    ...
    def run(self, *, days: int) -> dict[str, int]:
        ...
        with self.repo.connection() as conn:
            # Pre-fetch DQ stats for the whole range to avoid N+1 queries
            dq_df = pd.read_sql(
                """
